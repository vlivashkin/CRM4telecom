...
WHEN NOT MATCHED THEN 
    ...
    values(12101,'IPTV-Standard','Free basic packet, include 8 channels','25/12/2010 00:00:00',NULL,0);
...
WHEN NOT MATCHED THEN 
    INSERT (p.product_id,P.NAME ,P.DESCRIPTION,P.SALES_PERIOD_START,P.sales_period_end,P.BASELINE_PRICE)
    values(12102,'IPTV-11Plus','To basic 8 channels added 11 channels','14/03/2011 00:00:00',NULL,20);
...
WHEN NOT MATCHED THEN 
    INSERT (p.product_id,P.NAME ,P.DESCRIPTION,P.SALES_PERIOD_START,P.sales_period_end,P.BASELINE_PRICE)
    values(12103,'IPTV-Sport','8 bacis channels + 6 sports channels','04/06/2012 00:00:00',NULL,100);
...
WHEN NOT MATCHED THEN 
    INSERT (p.product_id,P.NAME ,P.DESCRIPTION,P.SALES_PERIOD_START,P.sales_period_end,P.BASELINE_PRICE)
    values(12104,'IPoE-Unlim100','IP over Ethernet, speed to 100 Mbit/s,'08/08/2010 00:00:00',NULL,1000);
...
WHEN NOT MATCHED THEN 
    INSERT (p.product_id,P.NAME ,P.DESCRIPTION,P.SALES_PERIOD_START,P.sales_period_end,P.BASELINE_PRICE)
    values(12105,'IPoE-Unlim60','IP over Ethernet, speed to 60 Mbit/s,'11/04/2010 00:00:00',NULL,600);    
...
WHEN NOT MATCHED THEN 
    INSERT (p.product_id,P.NAME ,P.DESCRIPTION,P.SALES_PERIOD_START,P.sales_period_end,P.BASELINE_PRICE)
    values(12106,'IPoE-Basic80','IP over Ethernet, speed to 80 Mbit/s, after 300 Gb - speed is limited','20/05/2010 00:00:00',NULL,400);    