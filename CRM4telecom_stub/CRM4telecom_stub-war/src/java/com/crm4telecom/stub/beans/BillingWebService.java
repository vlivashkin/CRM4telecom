 ...
 * @author root
 */
@WebService(serviceName = "services", portName = "BillingPort", endpointInterface = "com.crm4telecom.soap.Billing", targetNamespace = "http://soap.crm4telecom.com/", wsdlLocation = "WEB-INF/wsdl/schema.wsdl")
